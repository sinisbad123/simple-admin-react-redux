...
import { addCompanySubmit } from './companySubmit';
  ...
  return (
    <div className="content">
      <form
        ...
        onSubmit={handleSubmit(addCompanySubmit, dispatch)}
        >
        ...
        <div className="form-group">
          <label className="control-label col-md-3">Payback dates</label>
        ...
        <div className="form-group">
          <label className="control-label col-md-3">Sec Address</label>
          <div className="col-md-9">
            <Field
              name="sec_address"
              type="text"
