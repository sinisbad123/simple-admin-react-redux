...
import { addCategorySubmit } from './categorySubmit';
  ...
  return (
    <div className="content">
      <form
        ...
        onSubmit={handleSubmit(addCategorySubmit, dispatch)}
        >
        ...
        <div className="form-group">
          ...
          <label className="control-label col-md-3 text-success">optional</label>
        </div>

        <div className="form-group">
          <label className="control-label col-md-offset-2">* Note: The higher the number of priority, it will have more priority to be displayed within the app.</label>
        </div>
